...
# 复制预下载的 ONNX 模型缓存
COPY --from=dependencies --chown=helpdesk:helpdesk /root/.cache/chroma /home/helpdesk/.cache/chroma
...
RUN mkdir -p /app/data/chroma /app/logs /app/config && \
    chown helpdesk:helpdesk /app/data /app/data/chroma /app/logs /app/config
USER helpdesk
